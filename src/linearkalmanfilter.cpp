...
void LinearKalmanFilter::predictionStep(double dt)
{
...
Matrix2d LinearKalmanFilter::getVehicleStatePositionCovariance()
{
...
VehicleState LinearKalmanFilter::getVehicleState()
{
    if (isInitialised())
    {
...
void LinearKalmanFilter::predictionStep(GyroMeasurement gyro, double dt){predictionStep(dt);}
void LinearKalmanFilter::handleLidarMeasurements(const std::vector<LidarMeasurement>& dataset, const BeaconMap& map){}
void LinearKalmanFilter::handleLidarMeasurement(LidarMeasurement meas, const BeaconMap& map){}
