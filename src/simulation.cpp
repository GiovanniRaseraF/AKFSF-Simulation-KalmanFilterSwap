...
{
    m_kfilters = {
        std::make_shared<LinearKalmanFilter>(LinearKalmanFilter()),
        std::make_shared<ExtendedKalmanFilter>(ExtendedKalmanFilter()),
        std::make_shared<UnscentedKalmanFilter>(UnscentedKalmanFilter()),
    };
}
